...
#' @export
msi20.data=function(){
  return(gsheet2tbl("https://docs.google.com/spreadsheets/d/1J1rxI4kw1xXxFmm5NI_w4CfaeBwEdJi2nC-8kg0_C-M/edit?usp=sharing"))
}
...
daily.data=function(ticker,from,to){
  ...
  CodeValeur =reticulate::dict("ADH" = "9000" , "AFM" = "12200" , "AFI" = "11700" , "GAZ" = "7100" , "AGM" = "6700" ,
                    ...
                    "SBM" = "10400" , "STR" = "11500" ,"TGC"="MA0000012528", "TQM" = "11900" , "TIM" = "10100" , "TMA" = "12100" , "UMR" = "7500" ,
                    "WAA" = "6400" , "ZDJ" = "5800")
  isin=dat[ticker]
